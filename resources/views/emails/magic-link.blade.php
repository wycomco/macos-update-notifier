...
<body>
    ...
    <div class="content">
        ...
        <p>You requested a login link for your macOS Update Notifier account. Click the button below to sign in securely:</p>
        ...
        <div class="warning">
            <strong>Security Notice:</strong> This link will expire in 15 minutes and can only be used once. If you didn't request this login link, you can safely ignore this email.
        </div>
